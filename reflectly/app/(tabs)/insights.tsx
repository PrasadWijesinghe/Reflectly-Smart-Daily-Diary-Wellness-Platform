...
const styles = StyleSheet.create({
  ...
  toggleContainer: { flexDirection: "row", backgroundColor: "#E5E7EB", borderRadius: 12, padding: 4, marginTop: 16 },
  toggleButton: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingVertical: 10, borderRadius: 10 },
  toggleButtonActive: { backgroundColor: "#3B82F6" },
  toggleText: { fontSize: 14, fontWeight: "600", color: "#6B7280" },
  toggleTextActive: { color: "#FFFFFF" },
  summaryCard: { borderRadius: 16, padding: 18, marginTop: 16 },
  summaryHeader: { flexDirection: "row", alignItems: "center", marginBottom: 12 },
  summaryIconWrap: { width: 36, height: 36, borderRadius: 18, backgroundColor: "rgba(255,255,255,0.2)", alignItems: "center", justifyContent: "center", marginRight: 12 },
  summaryTitle: { fontSize: 16, fontWeight: "700", color: "#FFFFFF" },
  summaryLabel: { fontSize: 12, color: "rgba(255,255,255,0.7)", marginTop: 1 },
  summaryText: { fontSize: 13, color: "rgba(255,255,255,0.9)", lineHeight: 20 },
  card: { backgroundColor: "#FFFFFF", borderRadius: 16, padding: 18, marginTop: 16, elevation: 2, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 4 },
  cardHeader: { flexDirection: "row", alignItems: "center", marginBottom: 16, gap: 8 },
  cardTitle: { fontSize: 16, fontWeight: "700", color: "#1F2937" },
  moodRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 4 },
  moodItem: { alignItems: "center", gap: 8 },
  moodEmoji: { fontSize: 24 },
  moodDay: { fontSize: 11, color: "#9CA3AF", fontWeight: "600" },
  stressChart: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end", height: 100, paddingHorizontal: 4 },
  stressBarWrap: { alignItems: "center", flex: 1 },
  stressBarBg: { width: 20, height: 80, backgroundColor: "#F3F4F6", borderRadius: 10, justifyContent: "flex-end", overflow: "hidden" },
  stressBar: { width: "100%", borderRadius: 10 },
  stressDay: { fontSize: 11, color: "#9CA3AF", fontWeight: "600", marginTop: 8 },
  stressTip: { backgroundColor: "#FFFBEB", borderRadius: 10, paddingVertical: 10, paddingHorizontal: 14, marginTop: 16, alignItems: "center" },
  stressTipText: { fontSize: 12, color: "#F59E0B", fontWeight: "600", textAlign: "center" },
  topicRow: { flexDirection: "row", alignItems: "center", marginBottom: 14, gap: 10 },
  topicLabel: { flexDirection: "row", alignItems: "center", width: 130, gap: 8 },
  topicName: { fontSize: 13, fontWeight: "600", color: "#1F2937" },
  topicBarWrap: { flex: 1, height: 8, backgroundColor: "#F3F4F6", borderRadius: 4, overflow: "hidden" },
  topicBar: { height: "100%", borderRadius: 4 },
  topicCount: { fontSize: 12, fontWeight: "600", color: "#9CA3AF", width: 28, textAlign: "right" },
  sectionHeader: { flexDirection: "row", alignItems: "center", marginTop: 22, marginBottom: 12, gap: 6 },
  sectionTitle: { fontSize: 17, fontWeight: "700", color: "#1F2937" },
  tipCard: { backgroundColor: "#FFFFFF", borderRadius: 16, padding: 16, flexDirection: "row", alignItems: "center", gap: 14, elevation: 2, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 4 },
